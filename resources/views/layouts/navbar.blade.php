    ...
    <div class="container mx-auto flex items-center justify-between px-4">
        ...
        <div class="hidden md:block relative">
            ...
            @guest
                <div class="flex gap-2">
                    <a href="{{ route('login') }}" class="px-4 py-2 text-white border border-white rounded hover:bg-white hover:text-purple-900 transition">Login</a>
                    <a href="{{ route('register') }}" class="px-4 py-2 text-purple-900 bg-white rounded hover:bg-gray-200 transition">Register</a>
                </div>
            @endguest
        </div>
        ...
        <div class="md:hidden relative" x-data="{ open: false, userOpen: false }">
            ...
            <div x-show="open" @click.away="open = false" x-cloak
                ...
                @guest
                    <a href="{{ route('login') }}" class="px-4 py-2 hover:bg-purple-800">Login</a>
                    <a href="{{ route('register') }}" class="px-4 py-2 hover:bg-purple-800">Register</a>
                @endguest
            </div>
        </div>
