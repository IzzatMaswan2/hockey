    ...
    <div class="container" style="background-color: #4B006E; width: 100%;">
        <div class="row">
            <div class="col-md-6 col-sm-12 mb-3 d-flex align-items-center">
                ...
                <p class="text-white mb-0">Short description or tagline of the website.</p>
            </div>
            ...
            <div class="col-md-2 col-sm-6 mb-3">
                ...
                <ul class="list-unstyled">
                    <li><a href="tel:010-xxxx" class="text-decoration-none" style="color: #FFFFFF;"><i class="fa-solid fa-phone-volume mr-2" style="color: #000000;"></i>010-xxxx</a></li>
                    <li><a href="mailto:email@example.com" class="text-decoration-none" style="color: #FFFFFF;"><i class="fa-regular fa-envelope mr-2" style="color: #000000;"></i>Email</a></li>
                    <li><a href="#" class="text-decoration-none" style="color: #FFFFFF;"><i class="fa-solid fa-location-dot mr-2" style="color: #fb2323;"></i>Address</a></li>
                </ul>
            </div>
            <div class="col-md-2 col-sm-6 mb-3">
